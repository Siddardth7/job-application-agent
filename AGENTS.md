...
3. **Truth-Only Customization & Grounding Audit:** Start from `Resume/Final_Resumes/Resume_NewStrategy_Master.tex`. Ground every claim, employer, metric, and degree in the candidate master inventory (`data/candidate_resume_database.json`). Never invent tools, employers, or metrics.
