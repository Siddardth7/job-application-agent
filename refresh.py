...
# Default tracker artifact paths
DEFAULT_ARTIFACT = os.path.join(HERE, "job_tracker.artifact.html")
...
def sync_drop_reviews_to_learning_log(apps, path=None):
    ...
    lines = [DROP_START,
             ...
             "_Candidate's own reason for each drop, pulled from the Pipeline note field in the tracker. "
