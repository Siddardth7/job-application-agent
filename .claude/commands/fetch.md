...
Standalone entry to the `fetcher` subagent — use when Sid wants today's new-and-screened survivor list
...
2. Show Sid the survivor table + per-track/source counts + any Apify spend. Stop there — no scoring
