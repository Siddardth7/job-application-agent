...
description: >
  ...
  the stop point unless you explicitly ask for drafts. Runs only when the Ranker flagged referral rows.
...
3. **Step 8, per posting** — discover (location pass ≥5 target + alumni pass), classify each candidate
   ...
   there by default — do NOT draft outreach (8·3) unless you explicitly asked for drafts** (e.g. named a
   specific posting or said "draft these"). Log any location shortfall (<5) explicitly — never silently cap.
3a. **Only if you asked for drafts:** for the top 1-2 contacts per posting, draft the note yourself
...
status rollup. **Drafted outreach notes only appear if you explicitly asked for drafts** — otherwise
this file lists ranked/linked contacts only, ready for you to request drafts on later.
...
- Drafts are for you to review — leave them saved and ready, nothing more.
